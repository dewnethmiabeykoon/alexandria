        ...
        {years.map((yearData) => (
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              <div className="space-y-4 border-l-8 border-green-700 shadow-md rounded-xl p-4 bg-lime-100">
                ...
                {yearData.papers.map((paper, index) => (
                  <a
                    key={`en-${index}`}
                    href={paper.link}
                    className="block bg-green-600 text-white text-lg text-center py-3 rounded-lg hover:opacity-90 transition"
                  >
                    {paper.label}
                  </a>
                ))}
              ...
              <div className="space-y-4 border-l-8 border-lime-900 shadow-md rounded-xl p-4 bg-lime-100">
                <h4 className="text-2xl font-semibold text-center text-gray-800 mb-4">
                  Sinhala Medium
                </h4>
                {yearData.papers.map((paper, index) => (
                  <a
                    key={`si-${index}`}
                    href={paper.link}
                    className="block bg-lime-700 text-white text-lg text-center py-3 rounded-lg hover:opacity-90 transition"
                  >
                    {paper.label}
                  </a>
                ))}
